...
import com.benyq.sodaworld.music.controller.SodaPlayerController
import com.benyq.sodaworld.music.datacenter.MusicDataCenter
...
object SodaPlayManager {
    ...
    fun init(context: Context, iServiceNotifier: IServiceNotifier) {
        this.iServiceNotifier = iServiceNotifier
